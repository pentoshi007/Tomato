...
// - diskStorage: Saves files directly to the server's filesystem at a specified destination and filename. Useful when you want to persist files locally. Requires disk cleanup and proper file management on the server.
